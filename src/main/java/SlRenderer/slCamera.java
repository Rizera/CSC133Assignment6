...
// Interface goes here (above everything),
// change this slCamera class to implement the methods...
public class slCamera {
    ...
    public void setProjection() { //repurpose this for setOrthoProjection()
